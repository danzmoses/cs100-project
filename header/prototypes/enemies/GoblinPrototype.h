...
{
    public:
        GoblinPrototype() : EnemyPrototype() { setName("Goblin"); setHP(4); setMaxHP(4); setDescription("Adventurous, greedy, and loot-heavy! Goblins tend to have a higher chance to drop items."); }
